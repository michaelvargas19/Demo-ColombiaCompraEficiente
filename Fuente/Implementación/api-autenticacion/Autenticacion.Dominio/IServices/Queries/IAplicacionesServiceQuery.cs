...
namespace Autenticacion.Dominio.IServices.Queries
{
    ...
    {
        AplicacionQuery consultarAplicacion(string idAplicacion, bool estado, bool permiteJWT);

        ConfiguracionNewUserQuery GetConfiguracionNuevoUsuario(TokenJWT token);

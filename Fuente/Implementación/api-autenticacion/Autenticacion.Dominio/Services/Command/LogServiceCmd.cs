...
namespace Autenticacion.Dominio.Services.Command
{
    public class LogServiceCmd : ILogServiceCmd
    {
        ...
        public void AgregarLog(LogCmd log)
        {
            ...
            try
            {
                _LogAutenticacionAPI logE = new _LogAutenticacionAPI(log.Tipo, log.Usuario, log.Host, log.Aplicacion, log.Metodo, log.Entidad, log.Request, log.Response, log.EsExcepcion, log.Mensaje, log.Parametros);

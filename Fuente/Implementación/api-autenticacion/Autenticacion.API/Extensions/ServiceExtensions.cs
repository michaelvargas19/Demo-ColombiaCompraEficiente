...
namespace Autenticacion.API.Extensions
{
    public static class ServicioExtensiones
    {
        ...
        public static void ConfigureInterfaces(this IServiceCollection services, IConfiguration config)
        {

            services.Configure<SMTP_Settings>(config.GetSection("SMTPSettings"));
            ...
            services.AddScoped(typeof(ISesionesServiceCmd), typeof(SesionesServiceCmd));


            //Integración
            services.AddScoped(typeof(IConsumidorEmail), typeof(ConsumidorEmail));


            services.AddScoped(typeof(ILogOTPServiceCmd), typeof(LogOTPServiceCmd));

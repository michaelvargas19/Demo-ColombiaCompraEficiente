...
namespace Autenticacion.Infraestructura.Repositories.Command
{
    public class UserIdentityRepository : IUserIdentityRepository
    {
        ...
        public int GetAccessFailedCount(Usuario usuario)
        {
            try
            {
                int result = userManager.GetAccessFailedCountAsync(usuario).Result;
        ...
        public IdentityResult AccessFailed(Usuario usuario)
        {
            try
            {
                IdentityResult result = userManager.AccessFailedAsync(usuario).Result;
        ...
        public IdentityResult ResetAccessFailedCount(Usuario usuario)
        {
            try
            {
                IdentityResult result = userManager.ResetAccessFailedCountAsync(usuario).Result;
        ...
        public IdentityResult CreateUser(Usuario usuario, string contrasena)
        {
            try
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //AccountManager
                    Claim claimAuth = new Claim(ClaimTypes.AuthenticationMethod, EnumTipoAutenticacion.Contraseña.ToString());
        ...
        public IList<Claim> obtegerClaims(string nickname)
        {
            Usuario appUser = this.userManager.FindByNameAsync(nickname).Result;
            IList<Claim> claims = this.userManager.GetClaimsAsync(appUser).Result;
